...
public class Main {
    ...
    public static boolean checkForPassword(String str, int minLength) {
        ...
        // Require at least one lowercase, one uppercase, one digit, and minimum length
    ...
    public static List<String> extractEmails(String str) {
        ...
        // Match emails with at least one character before @ and domain utoronto.ca or mail.utoronto.ca
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // Contains the same capital letter twice anywhere in the string
